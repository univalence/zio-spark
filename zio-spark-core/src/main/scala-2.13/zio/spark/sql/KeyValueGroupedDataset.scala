...
final case class KeyValueGroupedDataset[K, V](
    underlyingKeyValueGroupedDataset: UnderlyingKeyValueGroupedDataset[K, V]
) { self =>
  ...
  def unpack[U](f: UnderlyingKeyValueGroupedDataset[K, V] => UnderlyingDataset[U]): Dataset[U] =
    Dataset(f(underlyingKeyValueGroupedDataset))
  ...
  ): Dataset[R] = unpack(_.cogroup(other.underlyingKeyValueGroupedDataset)(f))
   ...
   * @since 1.6.0
   */
  def flatMapGroups[U: Encoder](f: (K, Iterator[V]) => IterableOnce[U]): Dataset[U] = unpack(_.flatMapGroups(f))
  ...
  ): Dataset[U] = unpack(_.flatMapGroupsWithState(outputMode, timeoutConf)(func))
  ...
  def flatMapGroupsWithState[S: Encoder, U: Encoder](
    ...
    unpack(_.flatMapGroupsWithState(outputMode, timeoutConf, initialState)(func))
   ...
   * @since 1.6.0
   */
  def mapGroups[U: Encoder](f: (K, Iterator[V]) => U): Dataset[U] = unpack(_.mapGroups(f))
  ...
  def mapGroupsWithState[S: Encoder, U: Encoder](func: (K, Iterator[V], GroupState[S]) => U): Dataset[U] =
    unpack(_.mapGroupsWithState(func))
  ...
  ): Dataset[U] = unpack(_.mapGroupsWithState(timeoutConf)(func))
  ...
  def mapGroupsWithState[S: Encoder, U: Encoder](
    ...
    unpack(_.mapGroupsWithState(timeoutConf, initialState)(func))
   ...
   * @since 1.6.0
   */
  def agg[U1](col1: TypedColumn[V, U1]): TryAnalysis[Dataset[(K, U1)]] = unpackWithAnalysis(_.agg(col1))
  ...
  def agg[U1, U2](col1: TypedColumn[V, U1], col2: TypedColumn[V, U2]): TryAnalysis[Dataset[(K, U1, U2)]] =
    unpackWithAnalysis(_.agg(col1, col2))
  ...
  ): TryAnalysis[Dataset[(K, U1, U2, U3)]] = unpackWithAnalysis(_.agg(col1, col2, col3))
  ...
  ): TryAnalysis[Dataset[(K, U1, U2, U3, U4)]] = unpackWithAnalysis(_.agg(col1, col2, col3, col4))
  ...
  ): TryAnalysis[Dataset[(K, U1, U2, U3, U4, U5)]] = unpackWithAnalysis(_.agg(col1, col2, col3, col4, col5))
  ...
  ): TryAnalysis[Dataset[(K, U1, U2, U3, U4, U5, U6)]] = unpackWithAnalysis(_.agg(col1, col2, col3, col4, col5, col6))
  ...
  def agg[U1, U2, U3, U4, U5, U6, U7](
    ...
    unpackWithAnalysis(_.agg(col1, col2, col3, col4, col5, col6, col7))
  ...
  def agg[U1, U2, U3, U4, U5, U6, U7, U8](
    ...
    unpackWithAnalysis(_.agg(col1, col2, col3, col4, col5, col6, col7, col8))

  // ===============

  // Methods that need to be implemented
  //
  // [[org.apache.spark.sql.KeyValueGroupedDataset.keyAs]]
